import os
import numpy as np
from __moviepy.audio.io.ffmpeg_audiowriter import ffmpeg_audiowrite
from __moviepy.decorators import requires_duration
from __moviepy.tools import deprecated_version_of, extensions_dict

from __moviepy.Clip import Clip
