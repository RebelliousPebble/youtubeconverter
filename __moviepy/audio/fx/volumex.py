from __moviepy.decorators import audio_video_fx
...
def volumex(clip, factor):
    ...
    This effect is loaded as a clip method when you use __moviepy.editor,
    ...
    >>> newclip = clip.volumex(2) # only if you used "__moviepy.editor"
    """
