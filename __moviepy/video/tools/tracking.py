...
from __moviepy.decorators import (convert_to_seconds, use_clip_fps_by_default)
...
def manual_tracking(clip, t1=None, t2=None, fps=None, nobjects = 1,
    ...
    >>> from __moviepy.editor import VideoFileClip
    >>> from __moviepy.video.tools.tracking import manual_tracking
    ...
    >>> from __moviepy.video.tools.tracking import Trajectory
