...
import re
import numpy as np
from __moviepy.video.VideoClip import VideoClip, TextClip
from __moviepy.tools import cvsecs
from __moviepy.decorators import convert_to_seconds
...
class SubtitlesClip(VideoClip):
    ...
    >>> from __moviepy.video.tools.subtitles import SubtitlesClip
    >>> from __moviepy.video.io.VideoFileClip import VideoFileClip
