...
# file, but this would make the loading of __moviepy slower.
...
import __moviepy.video.compositing.transitions as transfx

# Tools

import __moviepy.video.tools as videotools
import __moviepy.video.io.ffmpeg_tools as ffmpeg_tools
...
try:
    from __moviepy.video.io.preview import show, preview
except ImportError:
...
try:
    from __moviepy.audio.io.preview import preview
except ImportError:
    def preview(self, *args, **kwargs):
        """ NOT AVAILABLE : clip.preview requires Pygame installed."""
        raise ImportError("clip.preview requires Pygame installed")
