...
packages = ["subprocess", "sys", "time", "traceback", "tempfile", "idna", "pytube", "PyQt5"]
options = {
    'build_exe': {
        'packages': packages,
    },
...
setup(
    ...
    options = options,
    version = "0.1",
    description = 'A python program built to flexibly download the best quality streams from YouTube using Qt5',
